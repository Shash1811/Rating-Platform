...
let UsersService = class UsersService {
    ...
    async findAll(filters) {
        ...
        const sortBy = filters.sortBy ?? filter_users_dto_1.UserSortBy.NAME;
        const sortOrder = (filters.sortOrder ?? filter_users_dto_1.SortOrder.ASC).toUpperCase();
    ...
    async getDashboardStats() {
        ...
        const totalStores = await this.userRepository.query('SELECT COUNT(*) FROM stores');
        const totalRatings = await this.userRepository.query('SELECT COUNT(*) FROM ratings');
        return {
            totalUsers,
